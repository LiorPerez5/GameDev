...
var MainScene = /** @class */ (function (_super) {
    ...
    MainScene.prototype.update = function () {
        var symbolList = this.add.layer();
        var symbol11 = this.add.sprite(215.0637664794922, 521.4500732421875, 'symbols', 'symbol_0.png');
        symbol11.scaleX = 0.5;
        symbol11.scaleY = 0.5;
        symbolList.add(symbol11);
        symbolList.remove(symbol11);
    };
    // Write your code here
